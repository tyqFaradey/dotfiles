...
У меня есть компьютер на нем стоит ubuntu server без графической оболочки мне нужно запускать на нем одно и только одно веб приложение 
то есть мне нужно чтобы оно именно открывалось на этом компьютере графичеси, и больше ничего сделать было нельзя